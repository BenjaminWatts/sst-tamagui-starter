...
var require_ScrollView = __commonJS({
  "../../node_modules/@tamagui/scroll-view/dist/cjs/ScrollView.js"(exports, module2) {
    ...
    var ScrollView2 = (0, import_web.styled)(
      import_react_native6.ScrollView,
      {
        ...
        variants: {
          fullscreen: {
            true: import_stacks9.fullscreenStyle
          }
        }
      },
      {
...
var require_Select = __commonJS({
  "../../node_modules/@tamagui/select/dist/cjs/Select.js"(exports, module2) {
    ...
    var SelectValueFrame = (0, import_core30.styled)(import_text5.Paragraph, {
      name: VALUE_NAME,
      userSelect: "none"
    });
    ...
    var SelectIcon = (0, import_core30.styled)(import_stacks9.XStack, {
      name: "SelectIcon",
      // @ts-ignore
      "aria-hidden": true,
    ...
    var SelectItem = React13.forwardRef(
      (props, forwardedRef) => {
        ...
        const textId = (0, import_core30.useId)();
        const {
          selectedIndex,
          setSelectedIndex,
          listRef,
    ...
    var SelectItemTextFrame = (0, import_core30.styled)(import_text5.SizableText, {
      name: ITEM_TEXT_NAME,
      userSelect: "none"
    });
    ...
    var SelectItemIndicatorFrame = (0, import_core30.styled)(import_stacks9.XStack, {
      name: ITEM_TEXT_NAME
    });
    ...
    var SelectGroupFrame = (0, import_core30.styled)(import_stacks9.YStack, {
      name: GROUP_NAME,
      width: "100%"
    });
    var SelectGroup = React13.forwardRef(
      (props, forwardedRef) => {
        ...
        const groupId = (0, import_core30.useId)();
    ...
    var SelectSeparator = (0, import_core30.styled)(import_separator.Separator, {
    ...
    var Select = (0, import_core30.withStaticProperties)(
      (props) => {
        const {
          __scopeSelect,
          children,
        ...
        const id = (0, import_core30.useId)();
    ...
    var SwitchThumb = SwitchThumbFrame.extractable(
      React13.forwardRef(
        (props, forwardedRef) => {
          ...
          const { size: size2, disabled, checked, unstyled } = useSwitchContext(
            THUMB_NAME,
            __scopeSwitch
          );
          return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
...
var require_Tooltip = __commonJS({
  "../../node_modules/@tamagui/tooltip/dist/cjs/Tooltip.js"(exports, module2) {
    ...
    var TooltipArrow = React13.forwardRef((props, ref) => {
      return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_popover.PopoverArrow, { componentName: "Tooltip", ref, ...props });
    });
